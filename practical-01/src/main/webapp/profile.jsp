    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logout-btn {
            ...
            text-align: center; background: #ff4757; color: white;
            text-decoration: none; border-radius: 8px; font-weight: bold;
            margin-top: 25px; transition: background 0.3s ease;
        }
...
<div class="profile-card">
    <div class="profile-header">
        <%-- Extracts the first letter of the user's name for a cool avatar effect --%>
    ...
    <div class="profile-body">
        ...
        <a href="signin.jsp" class="logout-btn">Sign Out</a>
    </div>
</div>
