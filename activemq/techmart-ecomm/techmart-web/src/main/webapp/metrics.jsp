...
<div class="container">
    ...
    <div class="page-header">
        ...
        <div>
            ...
            <a href="${pageContext.request.contextPath}/metrics/json"
               class="btn-secondary btn-sm" target="_blank">JSON API</a>
        </div>
    </div>
    ...
    <div class="metrics-grid">
        ...
        <div class="metric-card">
            ...
            <div class="metric-row">
                ...
                <span class="metric-value" id="live-avg-notification">
                    <fmt:formatNumber value="${avgNotificationTimeMs}"
                                      pattern="#,##0.00"/>ms
                </span>
            </div>
        </div>
        ...
        <div class="metric-card">
            ...
            <div class="metric-row">
                ...
                <span class="metric-value" id="live-avg-response">
                    <fmt:formatNumber value="${avgResponseTimeMs}"
                                      pattern="#,##0.00"/>ms
                </span>
            </div>
            <div class="metric-row">
        ...
        <div class="metric-card">
            ...
            <div class="metric-row">
                <span class="metric-label">Session Beans</span>
