    ...
    <c:choose>
        <c:when test="${not empty cartItems}">
            ...
            <table class="data-table">
                        ...
                        <td>
                            <form method="post"
                                ...
                                <input type="number" name="quantity"
                                       value="${item.quantity}" min="1" class="qty-input-sm"/>
                ...
                <tfoot>
                <tr>
                    <td colspan="3" class="total-label">Total (${itemCount} items)</td>
            ...
            <div class="cart-actions">
                <a href="${pageContext.request.contextPath}/cart/clear" class="btn-danger">
                    Clear Cart
                </a>
                <a href="${pageContext.request.contextPath}/products/" class="btn-secondary">
                    Continue Shopping
                </a>
                <button onclick="document.getElementById('checkoutForm').style.display='block'"
                        class="btn-primary">
                    Proceed to Checkout
                </button>
            </div>
